package com.github.euonmyoji.newhonor.bukkit.mung.configuration;

import com.github.euonmyoji.newhonor.bukkit.exception.ConfigException;
...
public class MungConfig {
    ...
    public void setDefault(String node, String defaultValue) {
